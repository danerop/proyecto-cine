...
VALUES(1, "Sonic 2", 2022, 150, "https://es.web.img3.acsta.net/pictures/22/02/18/10/20/5195258.jpg", "Después de establecerse en Green Hills, Sonic quiere demostrar que tiene madera de héroe. La prueba de fuego llega con el retorno del malvado Robotnik, y su nuevo compinche, Knuckles, en busca de una esmeralda que destruye civilizaciones."),
	  (2, "Dr Strange: Multiverso de la locura", 2022, 150, "https://www.ecartelera.com/carteles/13400/13413/005_m.jpg", "El Dr. Stephen Strange abre un portal al multiverso al utilizar un hechizo prohibido. Ahora, su equipo debe enfrentarse a una amenaza que podría destruirlo todo."),
      (3, "Animales Fantasticos 3", 2022, 150, "https://es.web.img3.acsta.net/pictures/22/03/16/12/44/0138242.jpg", "Ante una severa amenaza, el magizoólogo Newt Scamander lidera a un valiente grupo de magos y brujas que busca detener al malvado Gellert Grindelwald."),
      (4, "Bombonera: La película del templo", 2022, 150, "https://cineargentinohoy.com.ar/wp-content/uploads/2022/05/bombon_1652959544.jpg", "La historia de uno de los estadios más importantes del continente llega a la pantalla grande."),
