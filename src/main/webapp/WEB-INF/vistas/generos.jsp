...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav w-100 d-flex justify-content-evenly">
						...
						%>
						<%--  						
						    <li><form:form action="buscar" method="GET" class="d-flex"
								modelAttribute="datosBuscar">
	...
	<main class="container-fluid">
		...
		<fieldset>
			<legend>Generos seleccionados</legend>
			<div class="container-fluid">
				<c:forEach items="${generosFavoritos}" var="genero">
					<div class="d-inline-block rounded-3 p-1 bg-primary">${genero.getGenero().getNombre()}
						<a href="eliminargenero?g=${genero.getId()}" type="button"
							class="btn-close enabled" aria-label="Close"></a>
					</div>
				</c:forEach>
			</div>
		</fieldset>
		<br>
		<form:form action="validarGenerosFavoritos" method="POST"
			modelAttribute="datosFavoritos">
			<fieldset>
