...
<body>
  ...
  <!-- Modal -->
	...
	<h2 align="center" style="color: white; text-decoration: underline;">¡Conocé
		nuestras suscripciones!</h2>

	<div class="container-fluid">
		<div class="container p-5">
			<div class="row justify-content-evenly">
				<c:forEach items="${listaDeDetallesSuscripciones}" var="suscripcion"
					varStatus="sub" begin="1">
								...
								<div class="card card1 h-100">
									<div class="card-body">
										...
										<div class="d-grid my-3">
											<a href="pago-suscripcion?d=${suscripcion.id}"
												class="btn btn-outline-dark btn-block" role="button">Seleccionar</a>
										</div>
										<ul>
											<li>¡${suscripcion.cantidadBoletosGratis} entradas
												mensuales gratis!</li>
											<li>¡${suscripcion.descuentoEnBoletos.intValue()} OFF en
												entradas todos los días!</li>
										</ul>
									</div>
								</div>
							</div>
