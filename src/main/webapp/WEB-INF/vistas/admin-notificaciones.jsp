...
<body>
					...
					<div class="list-group" id="list-tab" role="tablist">
						<c:forEach items="${listaNotificaciones}" var="notificacion">
							<a class="list-group-item list-group-item-action"
								data-toggle="list" href="#list-peliculas${notificacion.getId()}"
								role="tab">${notificacion.getTitulo()}</a>
						</c:forEach>
					</div>
				</div>
				<div class="col-8">
					...
					<div class="tab-content">
						<c:forEach items="${listaNotificaciones}" var="notificacion">
							<div class="tab-pane fade p-3 mb-2 bg-white rounded"
								id="list-peliculas${notificacion.getId()}" role="tabpanel">
								<div class="row">
									<div class="col-8">
										...
										<br>
										<p>
											Titulo: ${notificacion.getTitulo()} <br> Texto:
											${notificacion.getTexto()}<br> Fecha emitida:
											${notificacion.getFecha()}<br>
										</p>
									</div>
	...
	<div class="container formularios bg-light rounded"
		...
		<div class="formulario-cargar-pelicula" style="padding: 1rem;">
			...
			<form:form action="agregar-notificacion" method="POST"
				modelAttribute="datosNotificacion">
				<h4>Formulario Para Crear Notificacion</h4>
				<hr class="colorgraph">
				<br>

				<form:label path="titulo" for="titulo">Titulo:</form:label>
				<form:input path="titulo" name="titulo" id="titulo"
					class="form-control" />
				<br>
				<form:label path="texto" for="texto">Texto:</form:label>
				<form:input path="texto" name="texto" id="texto"
					class="form-control" />
				<br>
